...
@section('title', 'Daftar Distributor - Toko Sumber Rejeki')
...
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('distributor.destroy', $d->ID_Distributor) }}" method="POST"
                                    class="d-inline" onsubmit="return confirm('Hapus distributor {{ $d->Nama_Distributor }}?')">
                                    @csrf
                                    @method('DELETE')
    ...
    <div id="excelForm" class="d-none mt-4">
        <form action="{{ route('distributor.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <a href="{{ route('distributor.downloadTemplate') }}" class="btn btn-secondary ms-2">📄 Unduh Template Excel</a>
        </form>
    </div>
@endsection
