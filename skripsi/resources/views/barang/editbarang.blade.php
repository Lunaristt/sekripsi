                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="Harga_Barang"
                                value="{{ $barang->Harga_Barang }}" placeholder="Masukkan Harga Jual Barang" required>
                        </div>
                            ...
                            <select class="form-control" name="ID_Distributor" required>
                                ...
                                @foreach($distributor as $d)
                                    <option value="{{ $d->ID_Distributor }}"
                                        {{ $barang->ID_Distributor == $d->ID_Distributor ? 'selected' : '' }}>
                                        {{ $d->Nama_Distributor }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="Besar_Satuan"
                                value="{{ $barang->Besar_Satuan ?? '' }}" placeholder="Contoh: 1, 1/2">
                        </div>
                            ...
                            <select class="form-control" name="ID_Satuan" required>
                                ...
                                @foreach($satuanbarang as $satuan)
                                    <option value="{{ $satuan->ID_Satuan }}"
                                        {{ $barang->ID_Satuan == $satuan->ID_Satuan ? 'selected' : '' }}>
                                        {{ $satuan->Nama_Satuan }}
                                    </option>
                                @endforeach
                            </select>
